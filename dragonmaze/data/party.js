...
export const COMPANIONS = [
  {
    ...
    attacks: [{ name: 'silver sword', toHit: 5, damage: '1d8+2', range: 'melee' }],
    sprite: 'hero_spawnee',
    emoji: '🌙',
  ...
  },
  {
    ...
    attacks: [{ name: 'twin swords', toHit: 6, damage: '1d6+3', range: 'melee' }],
  ...
  },
  {
    ...
    attacks: [{ name: 'flaming sword', toHit: 4, damage: '1d8+2', range: 'melee' }],
