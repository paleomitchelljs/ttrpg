...
//   'M' encounter · 'L' loot · 'B' region boss · 'b' mini-boss
...
// table: weighted wandering-monster picks. boss: fixed pack on 'B' (name +
//   preferred item drops). miniboss: fixed pack on 'b' (name; lesser/no drops).
